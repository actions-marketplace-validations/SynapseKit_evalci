...
- 2-minute setup
- Works with any LLM provider (OpenAI, Anthropic, Gemini, and [35 more](https://synapsekit.github.io/synapsekit-docs/))
...
EvalCI is built on [SynapseKit](https://synapsekit.github.io/synapsekit-docs/) — an async-native Python framework for LLM applications with 35 provider integrations, RAG pipelines, agents, graph workflows, verifiable audit trails, and a built-in evaluation framework.
